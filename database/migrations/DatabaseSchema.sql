...
--
-- Host: 192.168.10.10    Database: contacts
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  `authenticator_user_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `authenticator_token` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2017-12-19 12:54:17
