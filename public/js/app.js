...
$(document).ready(function () {
    ...
    window.Contact = {
        ...
        set id(value) {
            this._id = value;this.inject('id', value);
        },
        get name() {
            return this._name;
        },
        set name(value) {
            this._name = value;this.inject('name', value);
        },
        get email() {
            return this._email;
        },
        set email(value) {
            this._email = value;this.inject('email', value);
        },
        get phone() {
            return this._phone;
        },
        set phone(value) {
            this._phone = value;this.inject('phone', value);
        },
        get option_1() {
            return this._option_1;
        },
        set option_1(value) {
            this._option_1 = value;this.inject('option_1', value);
        },
        get option_2() {
            return this._option_2;
        },
        set option_2(value) {
            this._option_2 = value;this.inject('option_2', value);
        },
        get option_3() {
            return this._option_3;
        },
        set option_3(value) {
            this._option_3 = value;this.inject('option_3', value);
        },
        get option_4() {
            return this._option_4;
        },
        set option_4(value) {
            this._option_4 = value;this.inject('option_4', value);
        },
        get option_5() {
            return this._option_5;
        },
        set option_5(value) {
            this._option_5 = value;this.inject('option_5', value);
        },

        inject: function inject(field, value) {
        ...
        delete: function _delete(id) {
            ...
            this.showAlert('Are you sure you want to delete ' + this._name + '? <i class="btn btn-danger"  onclick="Contact.doDelete(' + id + ');"> YES, delete it! </i> ' + '   <i class="btn btn-primary" onclick="Contact.hideAlert()">NO, wait! I changed my mind.</i> ', ' <i class="fa fa-warning fa-2x"></i>', 'red', true);
            return;
        },
        ...
        doDelete: function doDelete(id) {
            ...
            $.ajax({
                ...
                success: function success(data) {
                    ...
                    $(dataRow).remove();
                    Contact.showAlert(Contact.name + ' has been deleted. ', ' <i class="fa fa-info-circle fa-2x"></i>');
                    Contact.resetForm();
                },
                error: function error(data) {
        ...
        deleteOption: function deleteOption(Option) {
            ...
            $('.opt-field').each(function (key, optRecord) {
                if (key < x) {
                    ...
                    // hide the unused fields
                    if (key) $(".optional-" + (key + 1) + "-container").addClass('hidden');
                    $(".contact-form").find("input#option_" + (key + 1)).val('');
                }
            });
        ...
        showAlert: function showAlert(txt, icon, bckColor, fadeOut) {
            $(".ga-message").html(txt);
            if (icon) {
                $(".ga-icon").html(icon);
            } else {
            ...
            if (typeof fadeOut === "undefined") setTimeout(function () {
        ...
        getOptionArray: function getOptionArray(exclude) {
            var x = 0;
            var optionList = [];
            $('.opt-field').each(function (key, optRecord) {
        ...
        injectObjectToForm: function injectObjectToForm() {
        ...
        injectFormToObject: function injectFormToObject() {
        ...
        injectTableToObject: function injectTableToObject(id) {
            dataRow = $(".data-table-elements").find("tr[data-id=" + id + "]");
            this._id = id;
        ...
        search: function search() {
            ...
            $.ajax({
                ...
                error: function error(data) {
                    ...
                    console.log('Error:', data);
                    if (data.responseJSON) Contact.showAlert('Oops! ' + data.responseJSON.errors.target["0"], '<i class="fa fa-exclemation"></i>', 'red', false);
                }
            });
        }
    };
